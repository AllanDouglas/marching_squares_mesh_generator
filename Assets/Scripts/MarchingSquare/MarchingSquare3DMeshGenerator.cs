...
namespace MarchingSquare
{
    public class MarchingSquare3DMeshGenerator : MarchingSquareMeshGenerator
    {
        ...
        protected override void EvaluateVertices(
           ...
           int[] triangles,
           IMeshVertexPool<MeshVertex> vertexPool
           )
        {
        ...
        private static void Fourteen(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
        ...
        private static void Thirteen(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
        ...
        private static void Twelve(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Back, 15, in value, BACK, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Left, 9, in value, LEFT, in neighbors);
        ...
        private static void Eleven(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
        ...
        private static void Ten(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Front, 6, in value, FRONT, in neighbors);
        ...
        private static void Fifteen(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Front, 15, in value, FRONT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Left, 15, in value, LEFT, in neighbors);
        ...
        private static void Nine(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Front, 9, in value, FRONT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Left, 15, in value, LEFT, in neighbors);
        ...
        private static void Six(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Right, 15, in value, RIGHT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Front, 6, in value, FRONT, in neighbors);
        ...
        private static void Five(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Right, 6, in value, RIGHT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Back, 9, in value, BACK, in neighbors);
        ...
        private static void Eight(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Left, 9, in value, LEFT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Back, 6, in value, BACK, in neighbors);
        ...
        private static void Seven(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> vertexPool, MeshCube cube, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Right, 15, in value, RIGHT, in neighbors);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, vertexPool, cube.Front, 15, in value, FRONT, in neighbors);
        ...
        private static void Four(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> meshVertexPool, MeshCube cubeMesh, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
        ...
        private static void Three(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> meshVertexPool, MeshCube cubeMesh, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, meshVertexPool, meshSquare, value);
        ...
        private static void Two(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> meshVertexPool, MeshCube cubeMesh, MeshSquare meshSquare, int value, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, meshVertexPool, meshSquare, value);
            DrawFace(ref vertexIndex, ref triangleIndex, triangles, meshVertexPool, cubeMesh.Right, 9, in value, RIGHT, in neighbors);
        ...
        private static void DrawFace(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> meshVertexPool, MeshSquare meshSquare, in int value, in int centerValue, in Side side, in CrossNeighbors<Neighbor<Square>> neighbors)
        {
            switch (side)
            {
                case Side.LEFT:
        ...
        private static void DrawFace(ref int vertexIndex, ref int triangleIndex, int[] triangles, IMeshVertexPool<MeshVertex> meshVertexPool, MeshSquare meshSquare, in int gridValue)
        {
